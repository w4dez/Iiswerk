...
document.addEventListener('DOMContentLoaded', function() {
    const sections = document.querySelectorAll('.product-card, .testimonial-card, .about-text, .contact-item');
...
window.addEventListener('scroll', function() {
    ...
    const heroImage = document.querySelector('.ai-bot-illustration');
    if (heroImage) {
